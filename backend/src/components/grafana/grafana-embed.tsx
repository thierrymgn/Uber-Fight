        ...
        <CardContent>
          <Alert>
            ...
            <AlertDescription className="space-y-2">
              <p>
                Le dashboard Grafana n&apos;est pas configuré. Pour l&apos;activer :
              </p>
              ...
              <Button
                ...
                className="mt-2"
                onClick={() =>
                  window.open("https://grafana.com/docs/grafana-cloud/", "_blank")
                }
              >
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        <p className="text-sm text-muted-foreground">
          Cliquez sur le bouton ci-dessous pour accéder au dashboard Grafana
          et visualiser les logs, métriques et performances en temps réel.
        </p>
